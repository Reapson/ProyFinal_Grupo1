...
public class AdministracionProveedores extends javax.swing.JFrame {
    ...
    private boolean checkCasillas(){
        if("".equals(txtEmpresa.getText()) || "".equals(txtRepuestoConsumible.getText()) || "".equals(txtCedula.getText()) || "".equals(txtNombre.getText()) || "".equals(txtApellido.getText()) ||
    ...
    private void initComponents() {
        ...
        txtRepuestoConsumible = new javax.swing.JTextField();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtRepuestoConsumible, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE))
                .addGap(15, 15, 15))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtRepuestoConsumible, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        ...
        if (checkCasillas()){
            ...
            if (Integer.parseInt(txtCedula.getText()) <= 0){
                ...
                try{
                    //Se crean las variables que combinen con los atributos de la bd
                    Proveedor proveedor = new Proveedor(txtEmpresa.getText().trim(), txtRepuestoConsumible.getText().trim(), Integer.parseInt(txtCedula.getText().trim()), txtNombre.getText().trim(),
    ...
    private javax.swing.JTextField txtRepuestoConsumible;
